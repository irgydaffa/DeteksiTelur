                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <img src="{{ $imageUrl ?? '' }}" alt="Original Image" class="w-full h-auto rounded border border-gray-300">
                            </div>
                            
                            <!-- Detected Image -->
                            <div>
                                <p class="text-sm font-medium text-gray-700 mb-2">Hasil Deteksi:</p>
                                <img src="data:image/jpeg;base64,{{ $imageBase64 ?? '' }}" alt="Detection Result" class="w-full h-auto rounded border border-gray-300">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-blue-50 border-l-4 border-blue-400 p-4 mb-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3">
                                ...
                                <p class="text-blue-600 mt-1">Beberapa telur mungkin tidak terdeteksi dalam gambar ini.</p>
                            </div>
                        </div>
